...
export type GetAllBugsByQuery = {
  ...
  bugs: Array<{
    ...
    status: BugStatus
    number: number
    Website: { __typename?: 'Website'; name: string }
  }>
}
...
export type GetBugDatasQuery = {
  ...
  bug: {
    ...
    File: Array<{ __typename?: 'File'; id: string; name: string; path: string }>
    user: {
      __typename?: 'User'
      first_name: string
      last_name: string
...
export type GetWidgetTokenQueryVariables = Exact<{
  where: WebsiteWhereUniqueInput
}>

export type GetWidgetTokenQuery = {
  __typename?: 'Query'
  widgetToken: { __typename?: 'WidgetToken'; widget_token: string }
}
...
export type GetBugDatasQueryResult = Apollo.QueryResult<
  ...
  GetBugDatasQueryVariables
>
export const GetWidgetTokenDocument = gql`
  query getWidgetToken($where: WebsiteWhereUniqueInput!) {
    widgetToken(where: $where) {
      widget_token
    }
  }
`
...
/**
 * __useGetWidgetTokenQuery__
 *
 * To run a query within a React component, call `useGetWidgetTokenQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetWidgetTokenQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetWidgetTokenQuery({
 *   variables: {
 *      where: // value for 'where'
 *   },
 * });
 */
export function useGetWidgetTokenQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetWidgetTokenQuery,
    GetWidgetTokenQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<GetWidgetTokenQuery, GetWidgetTokenQueryVariables>(
    GetWidgetTokenDocument,
    options
  )
}
export function useGetWidgetTokenLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetWidgetTokenQuery,
    GetWidgetTokenQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<GetWidgetTokenQuery, GetWidgetTokenQueryVariables>(
    GetWidgetTokenDocument,
    options
  )
}
export type GetWidgetTokenQueryHookResult = ReturnType<
  typeof useGetWidgetTokenQuery
>
export type GetWidgetTokenLazyQueryHookResult = ReturnType<
  typeof useGetWidgetTokenLazyQuery
>
export type GetWidgetTokenQueryResult = Apollo.QueryResult<
  GetWidgetTokenQuery,
  GetWidgetTokenQueryVariables
>
